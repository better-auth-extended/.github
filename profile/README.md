...
Contributions are always welcome. Check out [`CONTRIBUTING.md`](https://github.com/better-auth-extended/better-auth-extended/blob/main/CONTRIBUTING.md) for more details.
...
[MIT](https://github.com/better-auth-extended/better-auth-extended/blob/main/LICENSE.md)
